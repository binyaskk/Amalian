...
">
                <p>
                    <?php echo anchor("dashboard/home/logout",$this->lang->line("common_logout"), array('class' => 'button2 button-icon button-icon-rarrow')); ?>
                        </i>
                </p>
            </div>
        </div>
        ...
        <ul class="sidebar-menu">
            <li class="header">
                <?php foreach($first_name->result() as $name) { echo  $name->first_name; }?>
            </li>
            <?php
