   ...
   ?>
        ...
        <fieldset id="role_permission_info">
         ...
         ?>
			...
			if($module->module_id=="roles" && $role->role_id==1) { //disable user permission delete option for admin
			...
			echo form_checkbox("permissions[]",$module->module_id,$this->Role->has_permission($module->module_id,$role->role_id),$js);
						 ?>
