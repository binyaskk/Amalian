   ...
   ?>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            enable_delete('<?php echo $this->lang->line("roles_confirm_delete")?>', '<?php echo $this->lang->line("roles_none_selected")?>');
            ...
            <div id="title_bar">
                ...
                <div id="new_button">
                    <?php echo anchor("$controller_path/view/-1/width:$form_width",
                     "<div class='big_button float_left'><span>".$this->lang->line('roles_new')."</span></div>",
