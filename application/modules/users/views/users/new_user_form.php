<?php
   ...
   ?>
        ...
        <fieldset id="user_basic_info">
            <legend>
                <?php echo $this->lang->line("profiles_basic_information"); ?>
            </legend>
            <?php $this->load->view("users/users/form_basic_info"); ?>
        </fieldset>
        <fieldset id="employee_login_info">
            <legend>
                <?php echo $this->lang->line("profiles_login_info"); ?>
            </legend>
      ...
      ?>
            ...
            'id'=>'repeat_password'
                ...
                <div class="field_row clearfix">
                    <?php echo form_label($this->lang->line('profiles_role').':', 'Role',array('class'=>'wide')); ?>
                        <div class='form_field'>
                            <?php 
                        $attr=array('id'=>'role_list');
                         ...
                         {
                             //log_message("debug",$row['role_name']);
        ...
        <fieldset id="employee_permission_info">
            <!--   <legend>
                <?php echo $this->lang->line("profiles_permission_info"); ?>
            </legend>
            <p>
                <?php echo $this->lang->line("profiles_permission_desc"); ?>
            </p>
